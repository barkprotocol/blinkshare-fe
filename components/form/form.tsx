...
const Form: React.FC<FormProps> = ({
  ...
  const handlePreview = async () => {
    ...
    const recipientPubKey = new PublicKey("2NTvEssJ2i998V2cMGT4Fy3JhyFnAzHFonDo9dbAkVrg");
  ...
  const handleTweet = () => {
    const tweetText = `Check out this Blink I just made @blinksharedotfun: https://dial.to/?action=solana-action:${blinkLink}`;
